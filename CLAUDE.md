...
| `kind`     | Picked up by                                                |
| ---------- | ----------------------------------------------------------- |
| `sdk`      | `sync-sdks.yml`, `stale.yml`, `cleanup-skipped-runs.yml`, `migrate-claude.yml`, `migrate-infer.yml` |
| `docs`     | `sync-sdks.yml` (separate drift class E), `stale.yml`, `cleanup-skipped-runs.yml`, `migrate-claude.yml`, `migrate-infer.yml` |
| `adk`      | `sync-adks.yml`, `stale.yml`, `cleanup-skipped-runs.yml`, `migrate-claude.yml`, `migrate-infer.yml` |
| `agent`    | `bump-adl.yml`, `refresh-agent-manifest.yml`, `trigger-cd.yml`, `stale.yml`, `cleanup-skipped-runs.yml` |
| `none`     | `migrate-claude.yml`, `migrate-infer.yml` (infra/tooling repos with no sync/agent family; intentionally **not** swept by `stale.yml` / `cleanup-skipped-runs.yml`) |
